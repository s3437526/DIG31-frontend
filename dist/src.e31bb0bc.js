...
class Auth {
  ...
  async signUp(userData) {
    ...
    console.log(JSON.stringify(userData)); // if response not ok
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js"}],"views/pages/signup.js":[function(require,module,exports) {
"use strict";
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signup":"views/pages/signup.js","./views/pages/guide":"views/pages/guide.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  async firstUpdated() {
    ...
    const signupDialog = this.shadowRoot.querySelector('.signup-dialog'); // signinDialog.show()
    ...
    signupDialog.addEventListener('sl-overlay-dismiss', event => event.preventDefault()); // Close all other details when one is shown
    ...
    if (localStorage.accessLevel >= 1) {
      ...
      const signinDialog = this.shadowRoot.querySelector('.signin-dialog');
      signinDialog.addEventListener('sl-overlay-dismiss', event => event.preventDefault()); // if (this.show) signinDialog.show()
    }
  ...
  signInSubmitHandler(e) {
    ...
    console.log("Form data is: ".concat(JSON.stringify(e.detail.formData)));
...
//         if (this.show) signinDialog.show() // keep?
//     console.log(`JS section... Signed user is: ${this.show}`)
...
//             } */
//         </style>
// ${    console.log(`HTML section... Signed user is: ${this.show}`)}
//         <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
//             <sl-dialog no-header="true" slot="label" class="signin-dialog" style="--width: 30vw;">
//             <span class="dialog-heading">Sign in</span>
//             <div class="page-content page-centered">
...
},{}],"components/aa-signup-dialog.js":[function(require,module,exports) {
// import { LitElement, html, css } from "@polymer/lit-element";
// import { anchorRoute, gotoRoute } from '../Router'
// import Auth from '../Auth'
// import App from '../App'
