...
const routes = {
  ...
  '404': _.default // '/signin': signinView,
  // '/signup': signupView
  // '/profile': profileView,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/guide":"views/pages/guide.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  async firstUpdated() {
    ...
    menuItems.forEach(menuItem => {
      menuItem.addEventListener('click', e => {
        console.log("Target clicked was: ".concat(e.target.id));
  ...
  signInSubmitHandler(e) {
    ...
    const submitBtn = this.shadowRoot.querySelector('.submit-btn'); // console.log("button clicked")
    ...
    if (e.target.innerText === "Sign In") {
      ...
      _Auth.default.signUp(formData, () => {
        ...
        signupDialog.hide();
        submitBtn.removeAttribute('loading'); // if the person registered the new user is signed in then don't prompt them to log in

        if (!localStorage.accessLevel >= 1) signinDialog.show(); // If the user is admin then refresh their users list

        if (localStorage.accessLevel == 2) {
          _FetchAPI.default.getUsersAsync();
