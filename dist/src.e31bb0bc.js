...
function _templateObject() {
  const data = _taggedTemplateLiteral(["<h3>", "</h3>"]);
...
const listButton = item => {
  (0, _litElement.html)(_templateObject(), item);
};
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  async firstUpdated() {
    ...
    users = localStorage.accessLevel == 2 ? await _FetchAPI.default.getUsersAsync() : ""; // console.log(`Places are: ${JSON.stringify(places)}`)
  ...
  async renderPlaceButtons() {
    ...
    places.forEach(place => {
      console.log("Theeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee plaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaace is: ".concat(place.placeName));
  ...
  hamburgerClick() {
    ...
    console.log("Access level is is: ".concat(localStorage.accessLevel));
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), this.hamburgerClick, e => e.preventDefault(), e => e.preventDefault(), e => e.preventDefault(), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : "", this.user && this.user.firstName, _Auth.default.currentUser.accessLevel == 2 ? (0, _litElement.html)(_templateObject3(), () => (0, _Router.gotoRoute)('/profile')) : "", () => (0, _Router.gotoRoute)('/editProfile'), _Auth.default.currentUser.accessLevel == 2 ? (0, _litElement.html)(_templateObject4(), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile')) : "", () => _Auth.default.signOut(), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, () => _Auth.default.signOut(), _Router.anchorRoute, e => e.preventDefault(), e => e.preventDefault(), e => e.preventDefault(), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : "", _Auth.default.currentUser.accessLevel == 2 ? (0, _litElement.html)(_templateObject5(), () => (0, _Router.gotoRoute)('/profile')) : "", () => (0, _Router.gotoRoute)('/editProfile'), _Auth.default.currentUser.accessLevel == 2 ? (0, _litElement.html)(_templateObject6(), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile')) : "", () => _Auth.default.signOut());
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js","../FetchAPI":"FetchAPI.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
